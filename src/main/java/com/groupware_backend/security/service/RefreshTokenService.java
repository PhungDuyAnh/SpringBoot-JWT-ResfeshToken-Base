package com.groupware_backend.security.service;

import com.groupware_backend.entity.RefreshToken;
import com.groupware_backend.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${groupware.app.refreshTokenDurationMs}")
